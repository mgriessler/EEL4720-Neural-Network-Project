...
HD_PWD='/home/nlandy/EEL4720-Neural-Network-Project_copy/nn_base/nn_base/nn_base.runs/design_1_nn_axi_v4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_nn_axi_v4_0_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_1_nn_axi_v4_0_0.tcl
