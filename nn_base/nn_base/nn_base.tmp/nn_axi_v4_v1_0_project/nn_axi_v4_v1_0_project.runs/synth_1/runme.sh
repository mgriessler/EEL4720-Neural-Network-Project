...
HD_PWD='/home/nlandy/EEL4720-Neural-Network-Project_copy/nn_base/nn_base/nn_base.tmp/nn_axi_v4_v1_0_project/nn_axi_v4_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_axi_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source nn_axi_v1_0.tcl
