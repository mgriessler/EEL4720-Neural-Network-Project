...
#
# Generated by export_simulation on Wed Apr 12 22:18:18 -0400 2017
#
################################################################################
...
switch to the './nn_user_app_0.sh' script.

./nn_user_app_0.sh -reset_run
...
./nn_user_app_0.sh -noclean_files

For more information on the script, please type './nn_user_app_0.sh -help'.
