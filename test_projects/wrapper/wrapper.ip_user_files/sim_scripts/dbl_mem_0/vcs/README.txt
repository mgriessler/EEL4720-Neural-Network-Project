...
#
# Generated by export_simulation on Wed Apr 12 20:37:40 -0400 2017
#
################################################################################
...
switch to the './dbl_mem_0.sh' script.

./dbl_mem_0.sh -reset_run
...
./dbl_mem_0.sh -noclean_files

For more information on the script, please type './dbl_mem_0.sh -help'.
