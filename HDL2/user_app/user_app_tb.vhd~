...
begin
    ...
    begin
        ...
        for i in 0 to TEST_SIZE-1 loop
            ...
            mmap_wr_en   <= '1';
            mmap_wr_data <= std_logic_vector(to_unsigned(sepal_length_test(i), C_MMAP_DATA_WIDTH));
        ...
        for i in 0 to TEST_SIZE-1 loop
            ...
            mmap_wr_en   <= '1';
            mmap_wr_data <= std_logic_vector(to_unsigned(sepal_width_test(i), C_MMAP_DATA_WIDTH));
            wait until rising_edge(clk);
            mmap_wr_en <= '0';
        end loop;  -- i
        ...
        for i in 0 to TEST_SIZE-1 loop
            ...
            mmap_wr_en   <= '1';
            mmap_wr_data <= std_logic_vector(petal_length_test(i), C_MMAP_DATA_WIDTH));
            wait until rising_edge(clk);
            mmap_wr_en <= '0';
        end loop;  -- i
        ...
        for i in 0 to TEST_SIZE-1 loop
            ...
            mmap_wr_en   <= '1';
            mmap_wr_data <= std_logic_vector(petal_width_test(i), C_MMAP_DATA_WIDTH));
            wait until rising_edge(clk);
            mmap_wr_en <= '0';
        end loop;  -- i
